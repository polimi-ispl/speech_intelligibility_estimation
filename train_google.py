...
def train_one_configuration(norm, filter_outliers, rms_th, alg, win_min_max):
    ...
    # Load the features
    test_data_path = '/nas/home/cborrelli/speech_forensics/notebook/pickle/google/features_test-clean.pkl'
    train_data_path = '/nas/home/cborrelli/speech_forensics/notebook/pickle/google/features_train-clean-100.pkl'
    dev_data_path = '/nas/home/cborrelli/speech_forensics/notebook/pickle/google/features_dev-clean.pkl'
